...
If you want to see a demo of the entire set, go inside the folder "Scenes" of this package and open the included scene. Start the game, and use the following keys to interact with it:

UP ARROW KEY = Change camera view
DOWN ARROW KEY = Show next material
...
#Fixed shaders - Removed definition of built-in constant unity_LightGammaCorrectionConsts_PIDiv4