...
Shader "High Quality Glass/Refraction" {
    Properties {
        ...
        _MultiplyBaseColor ("Multiply Base Color", Range(0, 10)) = 1
...
////// Specular:
                ...
                float3 diffuseColor = (_BaseColor_var.rgb*_MultiplyBaseColor); // Need this for specular when using metallic
