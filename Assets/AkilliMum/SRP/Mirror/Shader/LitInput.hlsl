...
//TEXTURECUBE(_EnviCubeMapBaked);
//half4 _EnviCubeMapBaked_HDR;
//SAMPLER(sampler_EnviCubeMapBaked);
CBUFFER_END
...
TEXTURE2D(_LeftOrCenterDepthTexture);       SAMPLER(sampler_LeftOrCenterDepthTexture);
TEXTURE2D(_RightDepthTexture);       SAMPLER(sampler_RightDepthTexture);
