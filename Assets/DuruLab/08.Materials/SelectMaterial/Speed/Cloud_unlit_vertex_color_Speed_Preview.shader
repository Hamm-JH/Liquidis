	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction ( VertexInput v  )
			{
				...
				float temp_output_388_0 = ( _Noise * 5.0 );
				...
				#endif
				float3 vertexValue = ( ( objToWorldDir239 * ( _Noise * 0.002 ) * temp_output_8_0 ) + ( objToWorldDir213 * (0.0 + (simplePerlin3D78 - -1.0) * (1.0 - 0.0) / (1.0 - -1.0)) * ( _Noise * 0.001 ) ) + ( objToWorldDir257 * (0.0 + (simplePerlin3D255 - -1.0) * (1.0 - 0.0) / (1.0 - -1.0)) * ( _Noise * 0.001 ) ) );
				#ifdef ASE_ABSOLUTE_VERTEX_POS
...
/*ASEBEGIN
Version=18912
0;0;1920;1019;-3440.999;-1440.775;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;386;3594.891,2946.17;Inherit;False;Property;_Noise;_Noise;24;0;Create;True;0;0;0;False;0;False;0;1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;143;4384.924,3133.879;Float;False;Property;_NoiseScaleB;NoiseScale B;7;0;Create;True;0;0;0;False;0;False;1,1,1;-0.53,18.73,1;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;5;4615.051,1817.031;Float;False;Property;_3dNoiseSizeA;3dNoise Size A;2;0;Create;True;0;0;0;False;0;False;0;-19.6;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;246;4534.873,3854.899;Float;False;Property;_3dNoiseSizeC;3dNoise Size C;12;0;Create;True;0;0;0;False;0;False;0;-196.9;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;80;4518.223,2867.733;Float;False;Property;_3dNoiseSizeB;3dNoise Size B;6;0;Create;True;0;0;0;False;0;False;0;191.7;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;388;4438.638,1650.325;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;397;5448.627,1813.359;Inherit;False;Constant;_Float5;Float 5;25;0;Create;True;0;0;0;False;0;False;0.002;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;391;4859.003,3576.156;Inherit;False;Constant;_Float1;Float 1;25;0;Create;True;0;0;0;False;0;False;0.001;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;395;5377.407,2786.234;Inherit;False;Constant;_Float4;Float 4;25;0;Create;True;0;0;0;False;0;False;0.001;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;394;5552.985,2767.97;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;396;5671.353,1824.028;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;197;4170.305,475.2054;Float;False;Property;_Tiling;Tiling;18;0;Create;True;0;0;0;False;0;False;0,0;0.03,0.05;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;125;5393.821,1725.355;Float;False;Property;_NoiseStrengthA;Noise Strength A;5;0;Create;True;0;0;0;False;0;False;0;0.002;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=6370B7E9776806446E661A073C015DC37A728F20